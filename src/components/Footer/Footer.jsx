...
const Footer = () => {
  ...
  <div className="w-full px-20 mx-auto p-4 md:py-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <a href="" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
        <img src="" className="h-8 rounded-full" alt="" />
        <span className="self-center text-2xl font-bold whitespace-nowrap text-black"> Shopora </span>
      </a>
 ...
 Shopora  <span className='text-sm text-white font-normal'> @2025 All Rights Reserved.</span>
</span>
